...
const GA_MEASUREMENT_ID = "G-D3BWR2K01T";
...
function gtag_report_conversion(url) {
  ...
  gtag("event", "conversion", {
    send_to: "AW-17977899190/-PaVCOy9m_8bELbxw_xC",
    value: 0.1,
    currency: "AED",
...
(async function initDisplayAds() {
  ...
  const adSlots = [
    { adUnit: "/23330730517/gameorbit1.com_d1", divId: "myw_top_1" },
    { adUnit: "/23330730517/gameorbit1.com_d2", divId: "myw_top_2" },
    { adUnit: "/23330730517/gameorbit1.com_d3", divId: "myw_top_3" },
  ];
    ...
    googletag.cmd.push(function () {
      try {
        ...
        currentSlot = googletag
          .defineOutOfPageSlot(
            "/23330730517/gameorbit1.com_reward",
